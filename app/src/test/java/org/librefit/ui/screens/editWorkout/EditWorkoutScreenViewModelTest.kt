...
class EditWorkoutScreenViewModelTest {
    ...
    private val exercises = listOf(
        UiExerciseItem(UiExerciseWithSets(exercise = UiExercise(id = 11L, position = 0))),
        UiExerciseItem(UiExerciseWithSets(exercise = UiExercise(id = 22L, position = 1))),
        UiExerciseItem(UiExerciseWithSets(exercise = UiExercise(id = 33L, position = 2)))
    )
    ...
    fun `withNormalizedExercisePositions rewrites positions sequentially`() {
        val normalized = listOf(
            UiExerciseItem(UiExerciseWithSets(exercise = UiExercise(id = 22L, position = 99))),
            UiExerciseItem(UiExerciseWithSets(exercise = UiExercise(id = 11L, position = 44)))
